export default function LandingPage() {
  return (
    <div /*style={{ padding: '20px', maxWidth: '1200px', margin: 'auto' }} //ADD IF NEEDED HERE, shortens the screen size to be smaller*/ 
      className="min-h-screen bg-white text-gray-900">
        ...
        <footer className="text-sm text-center text-gray-500 py-6 border-t">
          &copy; {new Date().getFullYear()} HabitFlow. All rights reserved. Created by Justin Won.
        </footer>
    </div>
  )
}
